...
document.head.appendChild(msViewportStyle)}}());jQuery(document).ready(function($){if($(".hideshare")[0]){var topOfOthDiv=$(".hideshare").offset().top;$(window).scroll(function(){if($(window).scrollTop()>topOfOthDiv){$(".share").hide()}else{$(".share").show()}})}
...
if($('.post-read').length){var txt=$('.article-post')[0].textContent,wordCount=txt.replace(/[^\w ]/g,"").split(/\s+/).length;var readingTimeInMinutes=Math.floor(wordCount/250)+1;var readingTimeAsString=readingTimeInMinutes+" min read";$('.post-read').html(readingTimeAsString)}
...
lastScrollTop=st}
$('.site-content').css('margin-top',$('header').outerHeight()+'px')});var perPage=6;var numPages=3;var firstText='First';var lastText='Last';var urlactivepage=location.href;var home_page="/";!function(e,t){"function"==typeof define&&define.amd?define("ev-emitter/ev-emitter",t):"object"==typeof module&&module.exports?module.exports=t():e.EvEmitter=t()}("undefined"!=typeof window?window:this,function(){function e(){}
...
var n=this.columnWidth+=this.gutter,o=this.containerWidth+this.gutter,r=o/n,s=n-o%n,a=s&&1>s?"round":"floor";r=Math[a](r),this.cols=Math.max(r,1)},n.getContainerWidth=function(){var t=this._getOption("fitWidth"),i=t?this.element.parentNode:this.element,n=e(i);this.containerWidth=n&&n.innerWidth},n._getItemLayoutPosition=function(t){t.getSize();var e=t.size.outerWidth%this.columnWidth,i=e&&1>e?"round":"ceil",n=Math[i](t.size.outerWidth/this.columnWidth);n=Math.min(n,this.cols);for(var o=this.options.horizontalOrder?"_getHorizontalColPosition":"_getTopColPosition",r=this[o](n,t),s={x:this.columnWidth*r.col,y:r.y},a=r.y+t.size.outerHeight,h=n+r.col,u=r.col;h>u;u++)this.colYs[u]=a;return s},n._getTopColPosition=function(t){var e=this._getTopColGroup(t),i=Math.min.apply(Math,e);return{col:e.indexOf(i),y:i}},n._getTopColGroup=function(t){if(2>t)return this.colYs;for(var e=[],i=this.cols+1-t,n=0;i>n;n++)e[n]=this._getColGroupY(n,t);return e},n._getColGroupY=function(t,e){if(2>e)return this.colYs[t];var i=this.colYs.slice(t,t+e);return Math.max.apply(Math,i)},n._getHorizontalColPosition=function(t,e){var i=this.horizontalColIndex%this.cols,n=t>1&&i+t>this.cols;i=n?0:i;var o=e.size.outerWidth&&e.size.outerHeight;return this.horizontalColIndex=o?i+t:this.horizontalColIndex,{col:i,y:this._getColGroupY(i,t)}},n._manageStamp=function(t){var i=e(t),n=this._getElementOffset(t),o=this._getOption("originLeft"),r=o?n.left:n.right,s=r+i.outerWidth,a=Math.floor(r/this.columnWidth);a=Math.max(0,a);var h=Math.floor(s/this.columnWidth);h-=s%this.columnWidth?0:1,h=Math.min(this.cols-1,h);for(var u=this._getOption("originTop"),d=(u?n.top:n.bottom)+i.outerHeight,l=a;h>=l;l++)this.colYs[l]=Math.max(d,this.colYs[l])},n._getContainerSize=function(){this.maxY=Math.max.apply(Math,this.colYs);var t={height:this.maxY};return this._getOption("fitWidth")&&(t.width=this._getContainerFitWidth()),t},n._getContainerFitWidth=function(){for(var t=0,e=this.cols;--e&&0===this.colYs[e];)t++;return(this.cols-t)*this.columnWidth-this.gutter},n.needsResizeLayout=function(){var t=this.containerWidth;return this.getContainerWidth(),t!=this.containerWidth},i});if(typeof firstText=="undefined")firstText="First";if(typeof lastText=="undefined")lastText="Last";var noPage;var currentPage;var currentPageNo;var postLabel;pagecurrentg();function looppagecurrentg(pageInfo){var html='';pageNumber=parseInt(numPages/2);if(pageNumber==numPages-pageNumber){numPages=pageNumber*2+1}
pageStart=currentPageNo-pageNumber;if(pageStart<1)pageStart=1;lastPageNo=parseInt(pageInfo/perPage)+1;if(lastPageNo-1==pageInfo/perPage)lastPageNo=lastPageNo-1;pageEnd=pageStart+numPages-1;if(pageEnd>lastPageNo)pageEnd=lastPageNo;var prevNumber=parseInt(currentPageNo)-1;if(currentPage=="page"){html+='<li class="showpage firstpage"><a href="'+home_page+'">'+firstText+'</a></li>'}else{html+='<li><a href="/search/label/'+postLabel+'?&max-results='+perPage+'">'+firstText+'</a></li>'}
if(currentPageNo==3){if(currentPage=="page"){html+='<li><a href="'+home_page+'"><i class="fa fa-angle-double-left"></i></a></li>'}else{html+='<li><a href="/search/label/'+postLabel+'?&max-results='+perPage+'"><i class="fa fa-angle-double-left"></i></a></li>'}}else{if(currentPage=="page"){html+='<li><a href="#" onclick="redirectpage('+prevNumber+');return false"><i class="fa fa-angle-double-left"></i></a></li>'}else{html+='<li><a href="#" onclick="redirectlabel('+prevNumber+');return false"><i class="fa fa-angle-double-left"></i></a></li>'}}
if(pageStart>1){if(currentPage=="page"){html+='<li><a href="'+home_page+'">1</a></li>'}else{html+='<li><a href="/search/label/'+postLabel+'?&max-results='+perPage+'">1</a></li>'}}
if(pageStart>2){html+=' ... '}
for(var jj=pageStart;jj<=pageEnd;jj++){if(currentPageNo==jj){html+='<li class="active">'+jj+'</li>'}else if(jj==1){if(currentPage=="page"){html+='<li><a href="'+home_page+'">1</a></li>'}else{html+='<li><a href="/search/label/'+postLabel+'?&max-results='+perPage+'">1</a></li>'}}else{if(currentPage=="page"){html+='<li><a href="#" onclick="redirectpage('+jj+');return false">'+jj+'</a></li>'}else{html+='<li><a href="#" onclick="redirectlabel('+jj+');return false">'+jj+'</a></li>'}}}
if(pageEnd<lastPageNo-1){html+='...'}
if(pageEnd<lastPageNo){if(currentPage=="page"){html+='<li><a href="#" onclick="redirectpage('+lastPageNo+');return false">'+lastPageNo+'</a></li>'}else{html+='<li><a href="#" onclick="redirectlabel('+lastPageNo+');return false">'+lastPageNo+'</a></li>'}}
var nextnumber=parseInt(currentPageNo)+1;if(currentPage=="page"){html+='<li><a href="#" onclick="redirectpage('+nextnumber+');return false"><i class="fa fa-angle-double-right"></i></a></li>'}else{html+='<li><a href="#" onclick="redirectlabel('+nextnumber+');return false"><i class="fa fa-angle-double-right"></i></a></li>'}
if(currentPage=="page"){html+='<li class="displaypageNum lastpage"><a href="#" onclick="redirectpage('+lastPageNo+');return false">'+lastText+'</a></li>'}else{html+='<li class="displaypageNum lastpage"><a href="#" onclick="redirectlabel('+lastPageNo+');return false">'+lastText+'</a></li>'}
...
location.href=pAddress};(function($){var newerLink=$('.newpo');var olderLink=$('.oldpo');$.get(newerLink.attr('href'),function(data){newerLink.html($(data).find('.post h1.posttitle').text())},"html");$.get(olderLink.attr('href'),function(data2){olderLink.html($(data2).find('.post h1.posttitle').text())},"html")})(jQuery);var randomRelatedIndex,showRelatedPost;!function(e,a,l){var g={homePage:"https://blog.masihterjaga.id/",numPosts:10,summaryLength:0,titleLength:"auto",thumbnailWidth:255,thumbnailHeight:170,noImage:"https://1.bp.blogspot.com/-V978-oOrqIY/XOBwgKEAixI/AAAAAAAACq0/hckBbhtOHT8sWTp6nFEbFaIBm0fIvixFQCLcBGAs/s1600/masihterjaga-noimage.png",containerId:"related-post",newTabLink:!1,moreText:"Baca Selengkapnya",callBack:function(){}};for(var t in relatedPostConfig)g[t]="undefined"==relatedPostConfig[t]?g[t]:relatedPostConfig[t];var r=function(e){var t=a.createElement("script");t.type="text/javascript",t.src=e,l.appendChild(t)},A=function(e){var t,a,l=e.length;if(0===l)return!1;for(;--l;)t=Math.floor(Math.random()*(l+1)),a=e[l],e[l]=e[t],e[t]=a;return e},i="object"==typeof labelArray&&0<labelArray.length?"/-/"+A(labelArray)[0]:"";randomRelatedIndex=function(e){var t,a,l=e.feed.openSearch$totalResults.$t-g.numPosts,n=(t=1,a=0<l?l:1,Math.floor(Math.random()*(a-t+1))+t);r(g.homePage.replace(/\/$/,"")+"/feeds/posts/summary"+i+"?alt=json-in-script&orderby=updated&start-index="+n+"&max-results="+g.numPosts+"&callback=showRelatedPost")},showRelatedPost=function(e){var t,a,l,n,r=document.getElementById(g.containerId),i=A(e.feed.entry),o='<div class="row justify-content-center listrecent listrelated">',d=g.newTabLink?' target="_blank"':"";if(r){for(var h=0;h<g.numPosts&&h!=i.length;h++){a=i[h].title.$t,l="auto"!==g.titleLength&&g.titleLength<a.length?a.substring(0,g.titleLength)+"&hellip;":a,n="media$thumbnail" in i[h]&&!1!==g.thumbnailWidth?i[h].media$thumbnail.url.replace(/.*?:\/\//g,"//").replace(/\/s[0-9]+(\-c)?/,"/w"+g.thumbnailWidth+"-h"+g.thumbnailHeight+"-c"):g.noImage,"summary" in i[h]&&0<g.summaryLength&&i[h].summary.$t.replace(/<br ?\/?>/g," ").replace(/<.*?>/g,"").replace(/[<>]/g,"").substring(0,g.summaryLength);for(var c=0,u=i[h].link.length;c<u;c++)t="alternate"==i[h].link[c].rel?i[h].link[c].href:"#";(o+='<div class="col-lg-4 col-md-4 col-sm-4"><div class="card post height262"><a style="background-image:url('+n+');" class="thumbimage" href="'+t+'"'+d+'></a><div class="card-block"><h2 class="card-title"><a title="'+a+'" href="'+t+'"'+d+">"+l+"</a></h2></div></div></div>")}
r.innerHTML=o+="</div>",g.callBack()}},r(g.homePage.replace(/\/$/,"")+"/feeds/posts/summary"+i+"?alt=json-in-script&orderby=updated&max-results=0&callback=randomRelatedIndex")}(window,document,document.getElementsByTagName("head")[0])
