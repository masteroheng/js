      ...
      jQuery(document).ready(function ($) {
        ...
        $('a.smoothscroll[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function (event) {
      ...
      ! function (e, a, l) {
        var g = {
          homePage: "https://blog.masihterjaga.id/",
          numPosts: 10,
          summaryLength: 0,
          titleLength: "auto",
          thumbnailWidth: 255,
          thumbnailHeight: 170,
          noImage: "https://1.bp.blogspot.com/-V978-oOrqIY/XOBwgKEAixI/AAAAAAAACq0/hckBbhtOHT8sWTp6nFEbFaIBm0fIvixFQCLcBGAs/s1600/masihterjaga-noimage.png",
